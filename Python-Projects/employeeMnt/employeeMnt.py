# Employee Management System Using Python – HaiNg
from os import system
import re
# importing mysql connector
import mysql.connector
#Must install mysql-connector-python
#Require Mysql server active on port 3306
...
# create empdata table
cursorObject.execute("CREATE TABLE IF NOT EXISTS empdata ( Id INT(11) PRIMARY KEY , Name VARCHAR(1800), Emial_Id TEXT(1800),Phone_no INT( 12 ), Address TEXT(1000), Post TEXT(1000), Salary INT(20))")

# make a regular expression
# for validating an Email
regex = r'\b[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}\b'
# for validating an Phone Number
Pattern = re.compile("(0|358)?[4-9][0-9]{7}")
